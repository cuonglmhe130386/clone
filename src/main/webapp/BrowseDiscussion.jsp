...
<div class="site-wrap">
    ...
    <div class="site-section">
        <div class="container">
            <div class="row">
                <%-- Retrieve posts from the server and display them --%>
                <c:forEach var="post" items="${posts}">
                    <div class="col-md-4">
                        <div class="post-entry">
                            <a href="post.jsp?id=${post.id}" class="post-thumbnail"><img src="${post.image}" alt="Image" class="img-fluid"></a>
                            <div class="post-content">
                                <h2 class="post-title"><a href="post.jsp?id=${post.id}">${post.title}</a></h2>
                                <p class="post-excerpt">${post.excerpt}</p>
                                <p><a href="post.jsp?id=${post.id}" class="btn btn-primary">Read More</a></p>
                            </div>
                        </div>
                    </div>
                </c:forEach>
